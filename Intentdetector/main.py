...
# sys.path.insert(0,"G:\\Work\\Gaia-AI-Learning\\SLU-keras\\ATIS.keras-master\\data")
# sys.path.insert(0,"G:\\Work\\Gaia-AI-Learning\\SLU-keras\\ATIS.keras-master\\metrics")
